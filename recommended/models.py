...
class SavedSearch(models.Model):
    ...
    name = models.CharField(
        max_length=200, help_text="Human friendly name for this saved search"
    )
    ...
    location = models.CharField(
        max_length=200, blank=True, help_text="Location text (city)"
    )
    projects = models.TextField(
        blank=True, help_text="Project keyword(s), comma-separated"
    )
